...
ppx. files use for storytelling and communicating with stakeholders
...
##### [Southwest Airlines Flight Delay Prediction with Databrick's PySpark](https://github.com/sacayo/Data-Science-Projects/tree/main/Flight-Delay-Prediction)
...
This project investigates the causal impact of injecting Bitcoin-related comments on YouTube video engagement through a randomized controlled trial experiment. Utilizing YouTube's Data API for data collection and R for statistical analysis, we implemented a multi-level, between-subject experiment. Despite roadblock, we concluded there was no casual effects from this experiments.
...
This project examines the interrelation of age and income among different generations using data from the General Social Survey. Employing Ordinary Least Squares (OLS) regression with robust standard errors, we analyzed how age, education, and work hours influence income. For a more detail overview, click the link to the GitHub directory above. 
